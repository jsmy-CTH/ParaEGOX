...
这些结果不等于完整 workspace test/clippy/doc gates、fresh Ubuntu CI 或 production evidence。真实 credentialed DeepSeek
smoke 与 Mac 本机构建的 executable 仍未完成，因此还不能把配置中的 DeepSeek 路径描述成外部验证通过
