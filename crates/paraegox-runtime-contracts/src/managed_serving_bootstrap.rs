...
mod tests {
    ...
    fn pxag_describe_and_pxah_descriptor_round_trip_verify_and_lock_lengths() {
        ...
        assert_eq!(
            request.request_digest().as_bytes(),
            &[
                0x3d, 0x82, 0x51, 0xb7, 0x04, 0xe4, 0x5b, 0xba, 0x0d, 0xbb, 0xa0, 0x46,
                0x4f, 0x4b, 0x56, 0x18, 0xff, 0x99, 0x69, 0x59, 0x6b, 0x1f, 0x14, 0x90,
                0x0b, 0x84, 0xdd, 0xe3, 0x6b, 0xf4, 0xd6, 0x66,
            ]
        );
        ...
        assert_eq!(
            ...
            .as_bytes(),
            &[
                0xc1, 0x0d, 0xd9, 0xab, 0xa7, 0xd1, 0x85, 0x59, 0x5e, 0x79, 0x26, 0xf9,
                0xb9, 0x6e, 0xf0, 0xaa, 0x64, 0x05, 0x34, 0x8e, 0x4d, 0x38, 0x14, 0xa8,
                0x2f, 0xf6, 0xa5, 0xee, 0x8d, 0x9a, 0xda, 0x66,
            ]
        );
        assert_eq!(
        ...
        *controller_signature_tamper
        ...
        assert_eq!(
            ...
            &[
                0xb7, 0x08, 0x7f, 0xb5, 0x4f, 0x06, 0xcd, 0xb2, 0x21, 0x05, 0x47, 0x66,
                0x4f, 0x7a, 0x54, 0x4f, 0xc4, 0xf9, 0xcd, 0x02, 0x66, 0x57, 0x4b, 0x7d,
                0x42, 0xc0, 0x99, 0x7c, 0xd9, 0xf4, 0xd3, 0xa7,
            ]
        );
        ...
        assert_eq!(
            ...
            .as_bytes(),
            &[
                0xa7, 0xd7, 0xb4, 0x4c, 0xc0, 0x42, 0x70, 0xa6, 0xc5, 0x1f, 0x27, 0x3b,
                0xf0, 0x5b, 0x44, 0x2b, 0x18, 0xb5, 0x6d, 0x09, 0xe5, 0x3e, 0xcd, 0xc6,
                0x84, 0x86, 0x89, 0x01, 0x5b, 0xc5, 0x9b, 0xad,
            ]
        );
        assert_eq!(
